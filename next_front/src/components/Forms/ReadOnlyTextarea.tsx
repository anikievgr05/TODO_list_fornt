    ...
    return (
        <div className="pt-1 pb-1 flex items-start">
            ...
            <div className="flex flex-col flex-wrap">
                <div
                    className="text-silver_mist text-wrap w-96 h-48 resize-none bg-transparent border-2 focus:ring-0 focus:border-silver_mist focus:outline-none border-silver_mist rounded-lg outline-none"
                >
